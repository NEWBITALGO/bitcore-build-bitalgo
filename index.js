...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-bitalgo/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-bitalgo -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-bitalgo -o bitcore-lib-bitalgo.js';
    }
